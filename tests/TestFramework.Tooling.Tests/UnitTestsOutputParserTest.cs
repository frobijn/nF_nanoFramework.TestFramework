...
{ReportPrefix}:C:{TestClassWithSetupCleanup_FQN}:40000:{AsString(UnitTestLauncher.Communication.Done, communicateByNames)}
...
Messages    :
Cannot create the test context for the test (within the test method)
Setup within the test failed after 5 ms: AssertFail
...
Messages    :
Test proper passed, but teardown of context within test method failed
Cleanup within the test failed after 5 ms: Exception
