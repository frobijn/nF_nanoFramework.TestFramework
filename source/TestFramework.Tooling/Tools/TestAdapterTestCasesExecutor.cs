...
namespace nanoFramework.TestFramework.Tooling.Tools
{
	...
	/// </summary>
	public sealed class TestAdapterTestCasesExecutor : TestsRunner
	{
		#region Fields
		...
		public static void Run (TestExecutor_TestCases_Parameters parameters, Action<InterProcessCommunicator.IMessage> sendMessage, LogMessenger logger, CancellationToken cancellationToken)
		{
		...
		private TestAdapterTestCasesExecutor (TestCaseCollection selection, Action<InterProcessCommunicator.IMessage> sendMessage, LogMessenger logger, CancellationToken cancellationToken)
