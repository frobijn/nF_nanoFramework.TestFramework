        ...
        public void TestAdapter_RunTests_TestCases_VirtualDeviceOnly(bool allowRealHardware)
        {
            ...
            foreach (TestCase testCase in testResults.TestCases)
            {
                ...
                if (testCase.ShouldRunOnVirtualDevice)
                {
                    ...
                    if (testCase.FullyQualifiedName.StartsWith("TestFramework.Tooling.Execution.Tests.FailInTest.Test"))
                    {
    ...
    {{
        ...
        ""data.txt"": ""Content of the data.txt file""
            ...
            foreach (TestCase testCase in testResults.TestCases)
            {
                ...
                else if (testCase.FullyQualifiedName.StartsWith("TestFramework.Tooling.Execution.Tests.TestWithFrameworkExtensions.TestDeviceWithSomeFile"))
                {
                ...
                else if (testCase.FullyQualifiedName.StartsWith("TestFramework.Tooling.Execution.Tests.TestWithFrameworkExtensions.TestOnDeviceWithProgrammingError_ShouldTestOnDevice"))
                {
                ...
                else if (testCase.FullyQualifiedName.StartsWith("TestFramework.Tooling.Execution.Tests.TestWithFrameworkExtensions.TestOnDeviceWithProgrammingError_AreDevicesEqual"))
                {
    ...
    {{
        ...
        ""data.txt"": ""Content of the data.txt file""
            ...
            foreach (TestCase testCase in testResults.TestCases)
            {
                ...
                if (!testCase.ShouldRunOnVirtualDevice
                    && testCase.FullyQualifiedName.StartsWith("TestFramework.Tooling.Execution.Tests.TestWithFrameworkExtensions.TestDeviceWithSomeFile"))
                {
                    /// Should have been run on every real hardware device
                    Assert.AreEqual
                    (
