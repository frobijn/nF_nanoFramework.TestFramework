    ...
    public abstract class TestUsingTestFrameworkToolingTestsDiscovery_v3
    {
        ...
        public void CreateTestCases()
        {
            ...
            var testCases = new TestCaseCollection(
                new (string, string)[]
                {
                    (assemblyFilePath, $"{TestClassWithSetupCleanup_FQN}.{TestClassWithSetupCleanup_TestMethodName}(V)"),
                    (assemblyFilePath, $"{TestClassWithSetupCleanup_FQN}.{TestClassWithSetupCleanup_DataRowMethodName}(0,V)"),
                    (assemblyFilePath, $"{TestClassWithSetupCleanup_FQN}.{TestClassWithSetupCleanup_DataRowMethodName}(1,V)"),
                    (assemblyFilePath, $"{TestClassTwoMethods_FQN}.{TestClassTwoMethods_Method1Name}(V)"),
                    (assemblyFilePath, $"{TestClassTwoMethods_FQN}.{TestClassTwoMethods_Method2Name}(V)"),
                    (assemblyFilePath, $"{TestWithFrameworkExtensions_FQN}.{TestWithFrameworkExtensions_TestOnDeviceWithSomeFileName}(V)"),
                },
