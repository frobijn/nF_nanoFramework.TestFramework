        ...
        ""Namespace_3"": {
            ...
            ""properties"": {
                ...
                ""TestWithFrameworkExtensions"": {
                    ""description"": ""Specify which test methods should be included. List the names (and data row attributes) of the methods in an array, or specify \""*\"" to include all test methods."",
                    ""anyOf"": [ { ""type"": ""string"", ""enum"": [ ""*"" ] }, { ""type"": ""array"", ""items"": { ""type"": ""string"", ""enum"": [ ""TestDeviceWithSomeFile"", ""TestOnDeviceWithProgrammingError_AreDevicesEqual"", ""TestOnDeviceWithProgrammingError_ShouldTestOnDevice"" ] } ]
                },,
                ""TestWithMethods"": {
                    ""description"": ""Specify which test methods should be included. List the names (and data row attributes) of the methods in an array, or specify \""*\"" to include all test methods."",
...
Error: {Path.GetDirectoryName(projectFilePath1)}{Path.DirectorySeparatorChar}TestWithALotOfErrors.cs(55,10): Error: The number of arguments of the method does not match the number of configuration keys specified by the attribute that implements 'IDeploymentConfiguration'.",
            ...
            AssertSelection(specificationFilePath, testCases, "",
@"TestFramework.Tooling.Tests.NFUnitTest.TestWithFrameworkExtensions.TestOnDeviceWithSomeFile(V)",
@"{
    ""TestCases"": {
        ""TestFramework.Tooling.Tests.NFUnitTest"": {
            ...
            AssertSelection(specificationFilePath, testCases, "",
@"TestFramework.Tooling.Tests.NFUnitTest.TestAllCurrentAttributes.TestMethod1(1,V) DR=1",
@"{
    ""TestCases"": {
        ""TestFramework.Tooling.Tests.NFUnitTest"": {
            ""TestAllCurrentAttributes"": [
            ...
            AssertSelection(specificationFilePath, testCases, "",
@"TestFramework.Tooling.Tests.NFUnitTest.TestAllCurrentAttributes.TestMethod1(0,V) DR=0
TestFramework.Tooling.Tests.NFUnitTest.TestAllCurrentAttributes.TestMethod1(1,V) DR=1",
@"{
    ""TestCases"": {
        ""TestFramework.Tooling.Tests.NFUnitTest"": {
            ...
            AssertSelection(specificationFilePath, testCases, "",
@"TestFramework.Tooling.Tests.NFUnitTest.TestAllCurrentAttributes.TestMethod(V)
TestFramework.Tooling.Tests.NFUnitTest.TestAllCurrentAttributes.TestMethod1(0,V) DR=0
TestFramework.Tooling.Tests.NFUnitTest.TestAllCurrentAttributes.TestMethod1(1,V) DR=1",
@"{
    ""TestCases"": {
...
TestFramework.Tooling.Tests.NFUnitTest.TestAllCurrentAttributes.TestMethod1(0,V) DR=0",
    ...
    ""TestCases"": {
        ""TestFramework.Tooling.Tests.NFUnitTest"": {
            ...
            AssertSelection(specificationFilePath, testCases, "",
@"TestFramework.Tooling.Execution.Tests.TestWithFrameworkExtensions.TestDeviceWithSomeFile(V)
TestFramework.Tooling.Execution.Tests.TestWithMethods.Test1(0,V) DR=0
TestFramework.Tooling.Execution.Tests.TestWithMethods.Test1(1,V) DR=1
TestFramework.Tooling.Execution.Tests.TestWithMethods.Test2(V)
TestFramework.Tooling.Execution.Tests.TestWithNewTestMethodsAttributes.MethodToRunOnRealHardware(V)
TestFramework.Tooling.Tests.NFUnitTest.StaticTestClass.Method(V)
TestFramework.Tooling.Tests.NFUnitTest.TestAllCurrentAttributes.TestMethod(V)
TestFramework.Tooling.Tests.NFUnitTest.TestAllCurrentAttributes.TestMethod1(0,V) DR=0",
@"{
  ""TestCases"": {
