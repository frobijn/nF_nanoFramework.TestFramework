...
----------------------------------------
Test        : TestFramework.Tooling.Tests.NFUnitTest.TestAllCurrentAttributes.TestMethod1(0,V)
...
----------------------------------------
Test        : TestFramework.Tooling.Tests.NFUnitTest.TestAllCurrentAttributes.TestMethod1(1,V)
...
----------------------------------------
Test        : TestFramework.Tooling.Tests.NFUnitTest.TestWithMethods.Test(V)
...
----------------------------------------
Test        : TestFramework.Tooling.Tests.NFUnitTest.TestWithMethods.Test2(V)
...
----------------------------------------
Test        : TestFramework.Tooling.Tests.NFUnitTest.TestWithFrameworkExtensions.TestOnDeviceWithSomeFile(V)
...
----------------------------------------", false);
        ...
        private (UnitTestLauncherGenerator generator, UnitTestLauncherGenerator.Application application) UnitTestLauncher_GenerateApplication(bool communicateByNames, bool withDeploymentConfiguration = true)
        {
            ...
            {
                Assert.AreEqual(
$@"TestFramework.Tooling.Tests.NFUnitTest.TestWithFrameworkExtensions.TestOnDeviceWithSomeFile(V) - TestOnDeviceWithSomeFile [{Constants.VirtualDevice_Description}]: Address
".Trim().Replace("\r\n", "\n") + '\n',
            ...
            {
                Assert.AreEqual(
$@"TestFramework.Tooling.Tests.NFUnitTest.TestWithFrameworkExtensions.TestOnDeviceWithSomeFile(V) - TestOnDeviceWithSomeFile [{Constants.VirtualDevice_Description}]: Address;Device ID;xyzzy
TestFramework.Tooling.Tests.NFUnitTest.TestWithMethods.Test2(V) - Test2 [{Constants.VirtualDevice_Description}]: Make and model
".Trim().Replace("\r\n", "\n") + '\n',
                    string.Join("\n", from tc in application.MissingDeploymentConfigurationKeys
                                      orderby tc.Key.FullyQualifiedName, tc.Key.DisplayName
                                      select $"{tc.Key.FullyQualifiedName} - {tc.Key.DisplayName}: {string.Join(";", from key in tc.Value orderby key select key)}"
