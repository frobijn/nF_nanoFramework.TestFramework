...
namespace nanoFramework.TestFramework.Tooling
{
    public sealed class TestCase
    {
            ...
            HashSet<string> categories)
        {
            ...
            FullyQualifiedName = $"{method.ReflectedType.FullName}.{method.Name}({(dataRowIndex < 0 ? "" : $"{dataRowIndex},")}{(shouldRunOnVirtualDevice ? "V" : "H")})";
            ...
            #region Create a unique ID in a repeatable way
            var sha = SHA1.Create();
            ...
            AddString(AssemblyFilePath);
            AddString(FullyQualifiedName);
            sha.TransformFinalBlock(Array.Empty<byte>(), 0, 0);
            byte[] toGuid = new byte[16];
            Array.Copy(sha.Hash, toGuid, 16);
            Id = new Guid(toGuid);
            #endregion
        }
        #endregion
        ...
        /// <summary>
        /// Name of the test case to view in, e.g., the Test Explorer
        /// </summary>
